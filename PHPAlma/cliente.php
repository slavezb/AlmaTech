...
<div class="container1">
    ...
    <div class="button-app1">
		<?php	
        echo "<a href='incluir_cliente.php?value=incluir'><input type='submit' class='btn btn-info' id='btn-1' name='tipos-crud' value='Incluir' checked/></a><br/>";
        ?>
		</div>
	<div class="button-app2">
		<?php
		echo "<a href='buscar_cliente.php?value=buscar'><input type='submit' class='btn btn-info' id='btn-1' name='tipos-crud' value='Buscar' checked/></a><br/>";
         ?>
		</div>
	<div class="button-app3">
		<?php
		echo "<a href='alterar_cliente.php?value=alterar'><input type='submit' class='btn btn-info' id='btn-1' name='tipos-crud' value='Alterar' checked/></a><br/>";
         ?>
		</div>
	<div class="button-app4">
		<?php
		echo "<a href='deletar_cliente.php?value=deletar'><input type='submit' class='btn btn-info' id='btn-1' name='tipos-crud' value='Deletar' checked/></a><br/>";
        ?>
    </div>
</div>
